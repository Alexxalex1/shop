<footer class="page-footer font-small fixed-end" style="box-shadow: 0 14px 28px rgba(0,1,0,0.25), 0 10px 10px rgba(0,0,0,0.42);">
    ...
    <div class="container text-center text-md-left mt-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-2 col-xl-3 mx-auto mb-4">
                ...
                <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto green" style="width: 90px;">
                <p>
                    <a class="ins-ic" style="font-size: 50px" href="https://www.instagram.com/ppasshtet/" target="_blank">
                        <i class="fa fa-instagram red-text"> </i>
                    </a>
                    <a class="ins-ic" style="font-size: 50px" href="http://vk.com/alex_98" target="_blank">
